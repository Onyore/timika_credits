...
<nav id="sidebar" class='mx-lt-5 bg-primary' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=documents" class="nav-item nav-documents"><span class='icon-field'><i class="fa fa-download"></i></span> Downloads</a>	
				<?php if($_SESSION['login_type'] == 1): ?>
				<a href="index.php?page=users" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users"></i></span> Users</a>
				
			<?php endif; ?>
		</div>
		<!-- <a href="#" class="nav-item nav-downloads"><span class='icon-field'><i class="fa fa-th-list"></i></span> Downloads</a>	 -->
