...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="card">
			...
			<div class="card-body">
				<table class="table table-bordered table table-success table-striped" id="borrower-list">
					<colgroup>
						<col width="10%">
						<col width="35%">
						<col width="30%">
						...
						$i = 1;
						 ...
						 <tr>
						 	...
						 	<td class="text-center">
									 ...
									 <a href='tcpdf/pdf/timika.php? id="<?php echo $row['id'] ?>"'  type="button" data-id="<?php echo $row['id'] ?>"><i class="fa fa-arrow-down"></i></a>
									 <a href='index.php?page=documents? id="<?php echo $row['id'] ?>"'  type="button" data-id="<?php echo $row['id'] ?>"><i class="fa fa-arrow-up"></i></a>
						 	</td>
